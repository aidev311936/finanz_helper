...
export class LLM {
  ...
  /**
   * Generate JSON by instructing the model to output strict JSON.
   */
  ...
  async #openaiText(messages, temperature) {
    ...
    // OpenAI Responses API returns output as an array of content parts.
  ...
  async #geminiText(messages, temperature) {
    ...
    // Using generateContent endpoint
